    ...
    <div class="flex items-center justify-between mt-4 ">
        ...
        <div class="flex items-center space-x-2">
          <div>
            ...
            <h2 class="text-base font-medium text-slate-900 dark:text-navy-100"> 19</h2>
          </div>
          <div>
            <p class="text-xs text-slate-600 dark:text-navy-100"> Ж</p>
            <h2 class="text-base font-medium text-slate-900 dark:text-navy-100"> 8</h2>
          </div>
        </div>
    </div>
