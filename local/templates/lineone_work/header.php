                                ...
                                <div class="tab-content flex flex-col overflow-hidden">
                                    ...
                                    >
                                        <div class="mt-8 pb-8 text-center">
                                            <img
                                                    class="mx-auto w-36"
                                                    src="<?= SITE_TEMPLATE_PATH ?>/assets/images/illustrations/empty-girl-box.svg"
                                                    alt="image"
                                            />
                                            <div class="mt-5">
                                                <p
                            ...
                            <div class="swiper-wrapper">
                                ...
                                >
                                    <div class="grow">
                                        <img
                                                class="h-3"
                                                src="<?= SITE_TEMPLATE_PATH ?>/assets/images/payments/cc-visa-white.svg"
                                                alt="image"
                                        />
                                    </div>
                        ...
                        <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                            <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                                <div class="flex items-center space-x-2">
                                    <img
                                            class="h-10 w-10"
                                            src="<?= SITE_TEMPLATE_PATH ?>/assets/images/100x100.png"
                                            alt="image"
                                    />
                                    <div>
                                        <h2
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-3 space-y-3 px-2">
                            ...
                            >
                                ...
                                <img
                                        src="<?= SITE_TEMPLATE_PATH ?>/assets/images/800x600.png"
                ...
                >
                    ...
                    >
                        <div class="flex items-center space-x-3">
                            <img
                                    ...
                                    src="<?= SITE_TEMPLATE_PATH ?>/assets/images/illustrations/lms-ui.svg"
                                    alt="image"
                            />
                            <div>
                                <p
                    ...
                    >
                        <div class="flex items-center space-x-3">
                            <img
                                    class="h-10 w-10 rounded-lg object-cover object-center"
                                    src="<?= SITE_TEMPLATE_PATH ?>/assets/images/illustrations/store-ui.svg"
                                    alt="image"
                            />
                            <div>
                                <p
                    ...
                    >
                        <div class="flex items-center space-x-3">
                            <img
                                    class="h-10 w-10 rounded-lg object-cover object-center"
                                    src="<?= SITE_TEMPLATE_PATH ?>/assets/images/illustrations/chat-ui.svg"
                                    alt="image"
                            />
                            <div>
                                <p
                    ...
                    >
                        <div class="flex items-center space-x-3">
                            <img
                                    class="h-10 w-10 rounded-lg object-cover object-center"
                                    src="<?= SITE_TEMPLATE_PATH ?>/assets/images/illustrations/nft.svg"
                                    alt="image"
                            />
                            <div>
                                <p
